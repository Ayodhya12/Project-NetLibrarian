...
<div class="container">
<h1 align="center" style="color: #fff; border-bottom: 6px solid  #00b289; margin-bottom: 20px;  padding: 13px 0; width: 400px; ">Issue Books</h1>
<?php

$res=mysqli_query($conn,"SELECT registration.Email,book_detail.book_id,title,author,edition,borrow_books.issue_date,borrow_books.return_date FROM registration inner join borrow_books ON registration.Email=borrow_books.Email inner join book_detail ON borrow_books.book_id=book_detail.book_id  WHERE borrow_books.status='' AND borrow_books.issue_date!='0000-00-00' ORDER BY book_id ;");

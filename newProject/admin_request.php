...
<div class="container">
	...
	<h1 align="center" style="color: #fff; border-bottom: 6px solid #4caf50; margin-bottom: 20px;  padding: 13px 0; width: 400px; ">Request of Book</h1>
   <?php
   ...
   if(isset($_POST['submit']))
	...
	if(isset($_SESSION['login_user']))
	{
		$sql= "SELECT registration.Email,book_detail.book_id,title,author,edition FROM registration inner join borrow_books ON registration.Email=borrow_books.Email inner join book_detail ON  book_detail.book_id=borrow_books.book_id WHERE borrow_books.approve =''";
